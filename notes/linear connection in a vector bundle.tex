...
See [here](https://math.uchicago.edu/~may/REU2015/REUPapers/Sorce.pdf), §5 for a fantastic brief exposition.

See also: 
- \wref{linear connection 1-form} (next)
- \wref{exterior covariant derivative}
- \wref{covariant derivative}
- \wref{vector fields on curves} (previous)
- \wref{geodesic} (next)
- \wref{torsion of a connection}
- \wref{flat connection}
