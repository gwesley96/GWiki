...
\texorpdfstring{\Title{Hstar monad}}
...
b=\tz[scale=.7]{
    \coordinate(O) at (0,0); 
    \fill\href{O}{regB, rounded corners=5pt}rectangle ++(1,1); % Object b
},
\qquad\qquad
X=\tz[scale=.7]{
    \coordinate(O) at (0,0); 
    \clip\href{O}{rounded corners}rectangle ++(1,1);
    \fill\href{O}{regA}rectangle ++(1,1);                    % 1-morph X (Red)
    \fill\href{O}{regB}++(0.5,0)rectangle ++(0.5,1);              % 1-morph X (Blue side)
    \draw\href{O}{strC}++(0.5,0)--++(0,1);                       % Separator
},
\qquad\qquad
\gamma=\tz[scale=.7,yscale=-1]{
    \coordinate(O) at (0,0); 
    \fill\href{O}{regA}++(-0.25,0)rectangle ++(1.5,1);         % Gamma map
    \draw\href{O}{strA}++(0.5,0.5)--++(0,0.5);
