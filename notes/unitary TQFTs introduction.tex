...
- $\bar{f}$ is "the same process, but on the orientation-reversed manifold" — it lives elsewhere.
- $f^\dagger$ is "the time-reversed process" — it goes from $y$ back to $x$, on the same manifold.}
