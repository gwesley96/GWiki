...
\Summary{Demonstration of the tz.sty package for creating string diagrams and mathematical visualizations in GWiki.}
...
A morphism can be drawn inline: \tz{\draw[thick] (0,0) -- (1,0); \fill (0,0) circle (1.5pt); \fill (1,0) circle (1.5pt);} using the \verb|\tz{}| command.
\end{example}
...
\begin{tikzpicture}
  ...
  \draw[thick,arrow at=0.3] (0,-.5) -- (2,-.5) node[right] {Arrow at 30\%};
...
\begin{tikzpicture}
  ...
  \draw[thick,knot] (0,0) .. controls (0.5,0.5) and (1.5,0.5) .. (2,0);
